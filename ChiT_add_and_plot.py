...
for i in range(0, 2, 1):
	...
	if i > 0:
		chi_plot_spm.append(zspm-zspm[len(zspm)-1])
		chi_plot_ferro1.append(zferro1-zferro1[len(zferro1)-1])
		chi_plot_ferro2.append(zferro2-zferro2[len(zferro2)-1])
		chi_plot_ferri1.append(zferri1-zferri1[len(zferri1)-1])
		chi_plot_ferri2.append(zferri2-zferri2[len(zferri2)-1])
	elif i == 0:
		chi_plot_spm.append(zspm)
		chi_plot_ferro1.append(zferro1)
		chi_plot_ferro2.append(zferro2)
		chi_plot_ferri1.append(zferri1)
		chi_plot_ferri2.append(zferri2)


	ax[0,0].plot(T_plot_spm[i], ((fspm*chi_plot_spm[i]/N_Avo)/divisor_spm + (fferro1*chi_plot_ferro1[i]/N_Avo)/divisor_ferro1 + (fferro2*chi_plot_ferro2[i]/N_Avo)/divisor_ferro2 + (fferri1*chi_plot_ferri1[i]/N_Avo)/divisor_ferri1 + (fferri2*chi_plot_ferri2[i]/N_Avo)/divisor_ferri2), '-', color=colorstore[i], label=str(J3[len(J3)-1]))
	#axins1.plot(T_plot_spm[i], ((fspm*chi_plot_spm[i]/N_Avo)+(fferro1*chi_plot_ferro1[i]/N_Avo)+(fferro2*chi_plot_ferro2[i]/N_Avo)+(fferri1*chi_plot_ferri1[i]/N_Avo)+(fferri2*chi_plot_ferri2[i]/N_Avo))/divisor, '-', color=colorstore[i], label=str(J3[len(J3)-1]))
...
for i in range(0, 2, 1):
	...
	ax[0,1].plot(T_plot_spm[i], ((fspm*chi_plot_spm[i]/N_Avo)/divisor_spm + (fferro1*chi_plot_ferro1[i]/N_Avo)/divisor_ferro1 + (fferro2*chi_plot_ferro2[i]/N_Avo)/divisor_ferro2 + (fferri1*chi_plot_ferri1[i]/N_Avo)/divisor_ferri1 + (fferri2*chi_plot_ferri2[i]/N_Avo)/divisor_ferri2), '-', color=colorstore[i], label=str(J3[len(J3)-1]))
	#axins1.plot(T_plot_spm[i], ((fspm*chi_plot_spm[i]/N_Avo)+(fferro1*chi_plot_ferro1[i]/N_Avo)+(fferro2*chi_plot_ferro2[i]/N_Avo)+(fferri1*chi_plot_ferri1[i]/N_Avo)+(fferri2*chi_plot_ferri2[i]/N_Avo))/divisor, '-', color=colorstore[i], label=str(J3[len(J3)-1]))
...
for i in range(0, 2, 1):
	...
	ax[1,0].plot(T_plot_spm[i], ((fspm*chi_plot_spm[i]/N_Avo)/divisor_spm + (fferro1*chi_plot_ferro1[i]/N_Avo)/divisor_ferro1 + (fferro2*chi_plot_ferro2[i]/N_Avo)/divisor_ferro2 + (fferri1*chi_plot_ferri1[i]/N_Avo)/divisor_ferri1 + (fferri2*chi_plot_ferri2[i]/N_Avo)/divisor_ferri2), '-', color=colorstore[i], label=str(J3[len(J3)-1]))
	#axins1.plot(T_plot_spm[i], ((fspm*chi_plot_spm[i]/N_Avo)+(fferro1*chi_plot_ferro1[i]/N_Avo)+(fferro2*chi_plot_ferro2[i]/N_Avo)+(fferri1*chi_plot_ferri1[i]/N_Avo)+(fferri2*chi_plot_ferri2[i]/N_Avo))/divisor, '-', color=colorstore[i], label=str(J3[len(J3)-1]))
...
for i in range(0, 2, 1):
	...
	ax[1,1].plot(T_plot_spm[i], ((fspm*chi_plot_spm[i]/N_Avo)/divisor_spm + (fferro1*chi_plot_ferro1[i]/N_Avo)/divisor_ferro1 + (fferro2*chi_plot_ferro2[i]/N_Avo)/divisor_ferro2 + (fferri1*chi_plot_ferri1[i]/N_Avo)/divisor_ferri1 + (fferri2*chi_plot_ferri2[i]/N_Avo)/divisor_ferri2), '-', color=colorstore[i], label=str(J3[len(J3)-1]))
	#axins2.plot(T_plot_spm[i], ((fspm*chi_plot_spm[i]/N_Avo)+(fferro1*chi_plot_ferro1[i]/N_Avo)+(fferro2*chi_plot_ferro2[i]/N_Avo)+(fferri1*chi_plot_ferri1[i]/N_Avo)+(fferri2*chi_plot_ferri2[i]/N_Avo))/divisor, '-', color=colorstore[i])
...
fig.savefig("./results/Summed_ChiT_plot.png", format="png", dpi=1200)
plt.show()
plt.close()
